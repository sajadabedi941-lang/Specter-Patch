...
Write-Host ""
Write-Host "============================================================"
Write-Host " Specter RUNTIME CRASH FIX V2"
Write-Host " Purge flat Data\INI duplicates that crash ZH init"
Write-Host "============================================================"
Write-Host ""
...
if (-not (Test-Path -LiteralPath $DataIni)) { throw "Not found: $DataIni" }
