...
title Specter - Air Force Expansion Playable BIG Installer
cd /d "%~dp0"

echo.
echo ============================================================
echo  SPECTER PLAYABLE BIG INSTALLER
echo  Air Force Expansion repair package
echo ============================================================
echo.
...
(
  echo Specter Air Force Expansion Playable Build installed.
  echo InstalledAt=!DATE! !TIME!
  echo GameRoot=!GAMEROOT!
  echo Backup=!BACKUP!
) > "!GAMEROOT!\SPECTER_AIRFORCE_EXPANSION_PLAYABLE_INSTALLED.txt"
