...
title Specter Ultimate Warfare - Final Playable BIG Installer
cd /d "%~dp0"

echo.
echo ============================================================
echo  SPECTER ULTIMATE WARFARE - FINAL PLAYABLE BUILD INSTALLER
echo ============================================================
echo.
echo  This installer copies the rebuilt game BIG archives into
echo  your Specter / Generals Zero Hour game root:
...
(
  echo Specter Final Playable Build installed.
  echo InstalledAt=!DATE! !TIME!
  echo GameRoot=!GAMEROOT!
  echo Backup=!BACKUP!
) > "!GAMEROOT!\SPECTER_FINAL_PLAYABLE_INSTALLED.txt"
...
echo    !BACKUP!
echo.
echo  You can now launch Command ^& Conquer Generals Zero Hour
echo  Specter. The game will load these updated BIG archives.
echo.
pause
exit /b 0
