...
title Specter - UAE/Japan MQ9 + MilitaryHQ Playable BIG Installer
cd /d "%~dp0"

echo.
echo ============================================================
echo  SPECTER PLAYABLE BIG INSTALLER
echo  UAE MQ-9 / Japan MQ-9 / MilitaryHQ StockFactions
echo ============================================================
echo.
...
(
  echo Specter UAE/Japan MQ9 + MilitaryHQ Playable Build installed.
  echo InstalledAt=!DATE! !TIME!
  echo GameRoot=!GAMEROOT!
  echo Backup=!BACKUP!
) > "!GAMEROOT!\SPECTER_UAE_JAPAN_MQ9_MHQ_PLAYABLE_INSTALLED.txt"
