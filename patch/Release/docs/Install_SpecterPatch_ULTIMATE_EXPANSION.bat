...
title Specter Ultimate Expansion - Playable BIG Installer
cd /d "%~dp0"

echo.
echo ============================================================
echo  SPECTER ULTIMATE EXPANSION INSTALLER
echo  Combined final playable BIG package
echo ============================================================
echo.
echo  Installs ONE DATA BIG and ONE ART BIG into GameRoot:
echo    - _SPEC_DATA_ONE.big
echo    - _SPEC_ART_ONE.big
echo.
echo  Includes: Turkey aircraft, UAE/Japan MQ-9, MilitaryHQ,
echo  multi-unit repairs, Air Force Expansion aircraft.
echo.
...
(
  echo Specter Ultimate Expansion Playable Build installed.
