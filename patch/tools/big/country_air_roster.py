...
JAPAN = CountryAir(
    ...
    fighters=(
        Aircraft(1, "Command_ConstructJapanJetF35A", "JapanJetF35A", "SPEC_JapanJetF35A", "US_F35A", "dedicated F-35A US_F35A"),
        Aircraft(2, "Command_ConstructJapanJetF35B", "JapanJetF35B", "SPEC_JapanJetF35B", "AVF-35", "JSF F-35B; AIM-120 + AIM-9X only"),
        Aircraft(3, "Command_ConstructJapanJetF15J", "JapanJetF15J", "SPEC_JapanF15J", "LSFJPF15J", "pure AA AIM-120 + AIM-9X"),
        Aircraft(4, "Command_ConstructJapanJetF15DJ", "JapanJetF15DJ", "SPEC_JapanJetF15DJ", "LSFISF15E", "AIM-120 + F-15E GBU-31"),
        Aircraft(5, "Command_ConstructJapanJetF2A", "JapanJetF2A", "SPEC_JapanF2A", "JPF2", "ASM-2 + GBU-12"),
        Aircraft(6, "Command_ConstructJapanJetF2B", "JapanJetF2B", "SPEC_JapanF2B", "AGMZJPF2G", "AIM-120 + 2x GBU-12"),
        Aircraft(7, "Command_ConstructJapanJetF2Kai", "JapanJetF2Kai", "SPEC_JapanF2Kai", "JPF2", "AIM-9X + ASM-2"),
    ...
    heavy=(
        ...
        Aircraft(2, "Command_ConstructJapanJetC2", "JapanJetC2", "SPEC_JapanC130H", "JP_C2", "ready unique JP_C2"),
        Aircraft(3, "Command_ConstructJapanJetC130H", "JapanJetC130H", "SPEC_JapanC130H", "AVCargoPln", "heavy bomber FireWeapon"),
        Aircraft(4, "Command_ConstructJapanUAVRQ4", "JapanUAVRQ4", "SPEC_JapanRQ4", "US_RQ-4", "recon UAV"),
        Aircraft(5, "Command_ConstructJapanHelicopterAH64D", "JapanHelicopterAH64D", "Nat_ah64e", "LSFJapanAH64D", "gunship Hellfire+Hydra"),
        Aircraft(6, "Command_ConstructJapanHelicopterUH60J", "JapanHelicopterUH60J", "Nat_uh60", "US_UH60", "armed combat support"),
        Aircraft(7, "Command_ConstructJapanHelicopterCH47J", "JapanHelicopterCH47J", "SSChinookUnload", "US_CH47F", "transport only"),
        Aircraft(8, "Command_ConstructJapanJetV22", "AmericaJetV22Visual", "C17GlobalMaster", "AVOsprey", "keep USA V-22 object / AVOsprey"),
    ),
)
