...
JAPAN = CountryAir(
    ...
    fighters=(
        Aircraft(1, "Command_ConstructJapanJetF35A", "JapanJetF35A", "SPEC_JapanJetF35A", "AVF-35", "visible JSF AVF-35"),
        Aircraft(2, "Command_ConstructJapanJetF35B", "JapanJetF35B", "SPEC_JapanJetF35B", "AVF-35", "keep AVF-35; do not use JP_F35B"),
        Aircraft(3, "Command_ConstructJapanJetF15J", "JapanJetF15J", "SPEC_JapanF15J", "LSFJPF15J", "pure AA"),
        Aircraft(4, "Command_ConstructJapanJetF15DJ", "JapanJetF15DJ", "SPEC_JapanJetF15DJ", "LSFISF15E", "heavy JDAM strike"),
        Aircraft(5, "Command_ConstructJapanJetF2A", "JapanJetF2A", "SPEC_JapanF2A", "JPF2", "ASM-2 + JDAM"),
        Aircraft(6, "Command_ConstructJapanJetF2B", "JapanJetF2B", "SPEC_JapanF2B", "AGMZJPF2G", "light Paveway"),
        Aircraft(7, "Command_ConstructJapanJetF2Kai", "JapanJetF2Kai", "SPEC_JapanF2Kai", "JPF2", "ASM specialist"),
