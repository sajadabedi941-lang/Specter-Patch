...
def cannon(name: str, dmg: float, clip: int, delay: int, rng: float) -> str:
    # Must clone a known-working ZH fighter cannon. DamageType GUN is not valid
    # in Zero Hour and crashes Weapon.ini parse at the Weapon header.
    return f"""Weapon {name}
  PrimaryDamage = {dmg:.1f}
...
# Exact airfield button + unit identity strings. CONTROLBAR keys must be
# patched even when they already exist, because a prior pack swapped several
# South Korea / Vietnam construct labels.
FIGHTER_IDENTITY = [
    ("JapanJetF15JKai", "F-15J Kai"),
    ("JapanJetF15J", "F-15J"),
    ("JapanJetF15DJ", "F-15DJ"),
    ("JapanJetF2A", "F-2A"),
    ("JapanJetF2B", "F-2B"),
    ("JapanJetF2Kai", "F-2 Kai"),
    ("JapanJetF4EJKai", "F-4EJ Kai"),
    ("JapanJetX2Shinshin", "X-2 Shinshin"),
    ("JapanJetF35A", "F-35A"),
    ("JapanJetF35B", "F-35B"),
    ("JapanJetFX", "F-X"),
    ("JapanJetF3", "F-3 GCAP"),
    ("SouthKoreaJetF15K", "F-15K"),
    ("SouthKoreaJetF15KSlam", "F-15K Slam Eagle"),
    ("SouthKoreaJetF16C", "F-16C"),
    ("SouthKoreaJetF16D", "F-16D"),
    ("SouthKoreaJetKF16", "KF-16"),
    ("SouthKoreaJetF35A", "F-35A"),
    ("SouthKoreaJetKF21", "KF-21"),
    ("SouthKoreaJetKF21Blk2", "KF-21 Block 2"),
    ("SouthKoreaJetFA50", "FA-50"),
    ("SouthKoreaJetT50", "T-50"),
    ("SouthKoreaJetF4E", "F-4E"),
    ("SouthKoreaJetF5E", "F-5E"),
    ("VietnamJetMig29S", "MiG-29"),
    ("VietnamJetMig21bis", "MiG-21bis"),
    ("VietnamJetMig21", "MiG-21MF"),
    ("VietnamJetSu22", "Su-22M3"),
    ("VietnamJetSu22M4", "Su-22M4"),
    ("VietnamJetSu27", "Su-27SK"),
    ("VietnamJetSu27UB", "Su-27UBK"),
    ("VietnamJetSu30", "Su-30MK2"),
    ("VietnamJetSu30MK2", "Su-30MK2V"),
    ("VietnamJetYak130", "Yak-130"),
    ("VietnamJetL39", "L-39"),
    ("VietnamJetF5E", "F-5E"),
]
for _obj, _ident in FIGHTER_IDENTITY:
    CSF_LABELS[f"OBJECT:{_obj}"] = _ident
    CSF_LABELS[f"CONTROLBAR:Construct{_obj}"] = _ident
